...
public class JFrameModificarAlumno extends javax.swing.JFrame {

    /**
     * Creates new form JFrameModificar
     */
    
    public JFrameModificarAlumno() {
        initComponents();
        ...
        nomf1.setText((ControladoraLista.lista.get(i)).getNbre());
        docf1.setText((ControladoraLista.lista.get(i)).getDoc());
        dirf1.setText((ControladoraLista.lista.get(i)).getDir());
        int fecNac [] = new int [3];
        fecNac = ((ControladoraLista.lista.get(i)).getfNac());
        diaNacf1.setText((""+fecNac[0]));
        mesNacf1.setText(""+fecNac[1]);
        añoNacf1.setText(""+fecNac[2]);
        facf1.setText(((Alumno)ControladoraLista.lista.get(i)).getFac());
        carrf1.setText(((Alumno)ControladoraLista.lista.get(i)).getCar());
        int fecIng [] = new int [3];
        fecIng = ((((Alumno)ControladoraLista.lista.get(i)).getfIng()));
        diaIngref1.setText(""+fecIng[0]);
        mesIngref1.setText(""+fecIng[1]);
        añoingref1.setText(""+fecIng[2]);
        registerf1.setText(((Alumno)ControladoraLista.lista.get(i)).getReg());
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(ModificarBoton, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 380, 180, 30));
    ...
    private void ModificarBotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarBotonActionPerformed
        ...
        if      (  aux != 18 && aux != 17 && aux != 16
            ...
            ControladoraLista.lista.modify(alu,i);
            alert("Alumno modificado con éxito","Operación realizada");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameModificarAlumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
