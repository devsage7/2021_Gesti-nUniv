...
public class JFrameModificarAlumnoPG extends javax.swing.JFrame {

    /**
     * Creates new form JFrameModificarAlumnoPG
     */
    
    public JFrameModificarAlumnoPG() {
        initComponents();
        ...
        facf1.setText(((AlumnoPostGrado)ControladoraLista.lista.get(i)).getFac());
        carrf1.setText(((AlumnoPostGrado)ControladoraLista.lista.get(i)).getCar());
        int fecIng [] = new int [3];
        fecIng = ((((AlumnoPostGrado)ControladoraLista.lista.get(i)).getfIng()));
        diaIngref1.setText(""+fecIng[0]);
        mesIngref1.setText(""+fecIng[1]);
        añoingref1.setText(""+fecIng[2]);
        registerf1.setText(((AlumnoPostGrado)ControladoraLista.lista.get(i)).getReg());
        carrpgf.setText(((AlumnoPostGrado)ControladoraLista.lista.get(i)).getcarPos());
    }
    ...
    private void initComponents() {
        ...
        modificarBoton1 = new javax.swing.JButton();
        ...
        modificarBoton1.setBackground(new java.awt.Color(102, 0, 0));
        modificarBoton1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        modificarBoton1.setForeground(new java.awt.Color(255, 255, 255));
        modificarBoton1.setText("Modificar");
        modificarBoton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                modificarBoton1ActionPerformed(evt);
            }
        });
        getContentPane().add(modificarBoton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 390, 180, 30));
    ...
    private void modificarBoton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarBoton1ActionPerformed
        ...
        if      (  aux != 18 && aux != 17 && aux != 16
            ...
            ControladoraLista.lista.modify(aluPG,i);
            alert("Alumno de Post-Grado modificado con éxito","Operación realizada");
            this.setVisible(false);
        }  // end if
        else if(aux == 18) 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameModificarAlumnoPG.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton modificarBoton1;
