...
public class JDialog_AgregarDocente extends javax.swing.JDialog {

  
    public JDialog_AgregarDocente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        materiastxt.setText("Materias que dicta (Opcional)");
        getContentPane().add(materiastxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 350, -1, -1));

        confirmarBoton.setBackground(new java.awt.Color(102, 0, 0));
        confirmarBoton.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        getContentPane().add(confirmarBoton, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 390, 180, 30));
    ...
    private void confirmarBotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarBotonActionPerformed
        ...
        if      (  aux != 18 && aux != 17 && aux != 16
            ...
            ControladoraLista.lista.addLast(d);
            ...
            alert("Docente registrado con éxito","Operación realizada");
        } //end if
        else if(aux == 18) 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialog_AgregarDocente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialog_AgregarDocente dialog = new JDialog_AgregarDocente(new javax.swing.JFrame(), true);
